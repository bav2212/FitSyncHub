namespace FitSyncHub.Zwift.HttpClients.Models.Responses
{
    ...
    {
        public List<ZwiftRaceResultEntryResponse> Entries { get; init; }
    }

    public record ZwiftRaceResultEntryResponse
    {
        public ZwiftRaceResultActivityData ActivityData { get; init; }
        ...
        public ZwiftRaceResultProfileData ProfileData { get; init; }
        ...
        public ZwiftRaceResultSensorData SensorData { get; init; }
